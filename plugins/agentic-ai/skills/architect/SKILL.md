---
name: architect
description: "Use when the user wants to plan, architect, design, decompose, or break down a feature, task, or project before implementation — or revise an existing architecture plan. Triggers on: 'architect X', 'plan out X', 'break down X', 'design the architecture for X', 'create a plan for X', 'decompose X into phases', 'how should we build X', 'revise the plan for X'."
---
